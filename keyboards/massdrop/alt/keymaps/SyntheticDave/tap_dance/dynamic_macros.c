...
*/
void dm1_finished(qk_tap_dance_state_t *state, void *user_data) { dm_finished(state, user_data, DYN_REC_START1, DYN_MACRO_PLAY1, &recording_macro_1); }

/*
    Pg Dn key control (Dynamic Macro 2)
*/
void dm2_finished(qk_tap_dance_state_t *state, void *user_data) { dm_finished(state, user_data, DYN_REC_START2, DYN_MACRO_PLAY2, &recording_macro_2); }
